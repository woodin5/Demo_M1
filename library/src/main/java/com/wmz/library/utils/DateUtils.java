...
public class DateUtils {
    ...
    public static boolean isToday(Calendar calendar) {
        return  isToday(longToString(calendar.getTimeInMillis(),DateUtils.YYYY_MM_DD));
    }
    ...
    public static boolean isToday(long time) {
        return  isToday(longToString(time, DateUtils.YYYY_MM_DD));
    }
    ...
    public static boolean isToday(String date) {
        return   getCurrentStringTime(DateUtils.YYYY_MM_DD).equals(date);
    }
